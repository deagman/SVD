...
is located at ``/public/software/compiler/rocm/dtk-23.04/rocblas``.
...
``/public/software/compiler/rocm/dtk-23.04/rocsolver``.
...
.. code-block:: bash
    ...
    CXX=/public/software/compiler/rocm/dtk-23.04/bin/hipcc cmake -DCMAKE_INSTALL_PREFIX=rocsolver-install ../..
    make install
...
.. code-block:: bash
    ...
    CXX=/public/software/compiler/rocm/dtk-23.04/bin/hipcc cmake -DCMAKE_INSTALL_PREFIX=/home/user/rocsolverlib ../..
    make install
...
.. code-block:: bash
    ...
    mkdir -p build/release && cd build/release
    CXX=/public/software/compiler/rocm/dtk-23.04/bin/hipcc cmake -DCMAKE_INSTALL_PREFIX=rocsolver-install -Drocblas_DIR=/alternative/rocblas/location ../..
    make install
...
.. code-block:: bash
    ...
    CXX=/public/software/compiler/rocm/dtk-23.04/bin/hipcc cmake -DCMAKE_INSTALL_PREFIX=rocsolver-install -DCMAKE_BUILD_TYPE=Debug ../..
    make install
...
.. code-block:: bash
    ...
    mkdir -p build/release && cd build/release
    CXX=/public/software/compiler/rocm/dtk-23.04/bin/hipcc cmake -DCMAKE_INSTALL_PREFIX=rocsolver-install -DBUILD_SHARED_LIBS=OFF ../..
    make install
...
.. code-block:: bash
    ...
    mkdir -p build/release && cd build/release
    CXX=/public/software/compiler/rocm/dtk-23.04/bin/hipcc cmake -DCMAKE_INSTALL_PREFIX=rocsolver-install -DBUILD_CLIENTS_TESTS=ON -DBUILD_CLIENTS_BENCHMARKS=ON ../..
    make install
...
.. code-block:: bash
    ...
    mkdir -p build/release && cd build/release
    CXX=/public/software/compiler/rocm/dtk-23.04/bin/hipcc cmake -DCMAKE_INSTALL_PREFIX=rocsolver-install -DCPACK_SET_DESTDIR=OFF -DCPACK_PACKAGING_INSTALL_PREFIX=/public/software/compiler/rocm/dtk-23.04 ../..
    make install
    make package
...
.. code-block:: bash
    ...
    mkdir -p build/release && cd build/release
    CXX=/public/software/compiler/rocm/dtk-23.04/bin/hipcc cmake -DCMAKE_INSTALL_PREFIX=rocsolver-install -DCPACK_SET_DESTDIR=OFF -DCPACK_PACKAGING_INSTALL_PREFIX=/package/install/path ../..
    make install
    make package
