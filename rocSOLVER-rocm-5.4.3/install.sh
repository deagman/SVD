...
Options:
  ...
  --install_dir <installdir>  Specify path to the directory where the library package
                              ...
                              (Default is /public/software/compiler/rocm/dtk-23.04)
...
# global variables
# #################################################
rocm_path=/public/software/compiler/rocm/dtk-23.04
...
if [[ "${build_relocatable}" == true ]]; then
    rocm_rpath=" -Wl,--enable-new-dtags -Wl,--rpath,/public/software/compiler/rocm/dtk-23.04/lib:/public/software/compiler/rocm/dtk-23.04/lib64"
