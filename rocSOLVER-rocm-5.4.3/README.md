...
rocSOLVER and install to `/public/software/compiler/rocm/dtk-23.04`:
...
system environment, but here is a typical example:
    ...
    /public/software/compiler/rocm/dtk-23.04/bin/hipcc -I/public/software/compiler/rocm/dtk-23.04/include -c example.cpp
    /public/software/compiler/rocm/dtk-23.04/bin/hipcc -o example -L/public/software/compiler/rocm/dtk-23.04/lib -lrocsolver -lrocblas example.o
