...
def parse_args():
    ...
    parser.add_argument(     '--rocblas_dir', dest='rocblas_dir', type=str, required=False, default = "",
                        help='Specify path to an existing rocBLAS install directory (optional, default: /public/software/compiler/rocm/dtk-23.04/rocblas)')
    parser.add_argument(     '--rocsolver_dir', dest='rocsolver_dir', type=str, required=False, default = "",
                        help='Specify path to an existing rocSOLVER install directory (optional, default: /public/software/compiler/rocm/dtk-23.04/rocsolver)')
...
def config_cmd():
    ...
    if os.name == "nt":
        ...
        rocm_path = os.getenv( 'ROCM_PATH', "/public/software/compiler/rocm/dtk-23.04")
        cmake_executable = "cmake"
